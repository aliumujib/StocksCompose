...
import Build_gradle.Plugin.hiltAndroidLib
...
gradlePlugin {
    plugins {
        ...
        register(hiltAndroidLib) {
            id = hiltAndroidLib
            implementationClass = "plugin.HiltAndroidLibraryPlugin"
        }
...
object Plugin {
    ...
    const val hiltAndroidLib: String = "hiltAndroidLibrary"
